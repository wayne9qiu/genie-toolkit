...
module.exports = class LocalParserClient {
    constructor(modeldir, locale, split, platform, exactmatcher = null, tpClient = null, options = {}) {
        this._locale = locale;
        this._split = split;
        this._langPack = I18n.get(locale);
        this._tokenizer = this._langPack.getTokenizer();
        this._predictor = new Predictor(options.id || 'local', modeldir, options.nprocesses, this._split);
