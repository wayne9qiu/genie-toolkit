...
class SentenceEvaluator {
    constructor(locale, parser, schemaRetriever, tokenized, debug, outputErrors, complexityMetric, ex) {
        this._parser = parser;
        this._tokenized = tokenized;
        this._debug = debug;
        this._outputErrors = outputErrors;
...
class SentenceEvaluatorStream extends Stream.Transform {
    constructor(locale, parser, schemas, tokenized, debug, outputErrors, complexityMetric) {
    ...
    _transform(ex, encoding, callback) {
        const evaluator = new SentenceEvaluator(this._locale, this._parser, this._schemas, this._tokenized, this._debug, this._outputErrors, this._complexityMetric, ex);
